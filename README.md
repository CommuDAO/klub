...
Event check-in on KUB Chain, wired to the KUB Chain launchpad and DEX. Show up, check in, earn from the
reward pool.
...
1. Fill in the real launchpad and router signatures in
   `contracts/contracts/mainnet/KlubDexAdapter.sol`, then `forge test`.
